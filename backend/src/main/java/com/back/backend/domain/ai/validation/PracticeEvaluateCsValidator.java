...
/**
 * CS 문제은행 답변 평가 AI 응답 검증기 (템플릿: ai.practice.evaluate.cs.v1)
 */
public class PracticeEvaluateCsValidator implements AiResponseValidator {

    private static final String TEMPLATE_ID = "ai.practice.evaluate.cs.v1";
    private static final String SCHEMA_FILE = "practice-evaluate.schema.json";

    private final JsonSchemaValidator jsonSchemaValidator;

    public PracticeEvaluateCsValidator(JsonSchemaValidator jsonSchemaValidator) {
