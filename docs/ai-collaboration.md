...
linked_issue_or_pr: docs-governance-v9
applies_to: ai-collaboration-and-document-governance
---
...
- 백엔드 기준 버전은 Java 25, Spring Boot 4.0.3을 사용한다.
- DB migration 도구는 Flyway를 사용하고 경로는 `backend/src/main/resources/db/migration`를 사용한다.
- 업로드 형식은 `PDF`, `DOCX`, `MD`
...
- 초기 migration 파일 생성 후 `docs/db/schema.md`와 연결
