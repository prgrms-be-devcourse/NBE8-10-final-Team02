...
| FR-06 | 면접 결과 저장 및 히스토리 조회 | SCR-14~SCR-16 | `/interview/sessions/{sessionId}/result` 및 세션 조회 API | `interview_sessions`, `interview_answers`, `feedback_tags`, `interview_answer_tags` | `ai.interview.evaluate.v1`, `ai.interview.summary.v1` | 결과 생성 실패 후 재시도, 점수/태그 저장, 활성 세션 배너, 히스토리 상세 조회 |
